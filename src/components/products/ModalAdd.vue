        ...
        <div v-if="show" class="fixed inset-0 bg-gray-500/60 flex items-center justify-center z-50">
            <div class="bg-white p-6 rounded-xl shadow-xl w-full max-w-md border border-indigo-100">
                ...
                <div class="mt-6 flex justify-end gap-4">
                    <button @click="$emit('close')" class="px-4 py-2 rounded bg-gray-100 hover:bg-gray-200 text-gray-700 cursor-pointer">
                        Batal
                    </button>
                    <button @click="handleSubmit" class="px-4 py-2 rounded bg-indigo-600 hover:bg-indigo-700 text-white cursor-pointer">
                        Simpan
                    </button>
                </div>
            </div>
